...
class CometChatMessageEvents {
  ...
  static addMessagesListener(String listenerId, CometChatMessageEventListener listenerClass) {
  ...
  static void onCustomInteractiveMessageReceived(dynamic message) {
    messagesListener.forEach((key, value) {
