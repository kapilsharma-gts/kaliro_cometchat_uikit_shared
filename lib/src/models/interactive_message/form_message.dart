...
class FormMessage extends InteractiveMessage {
  ...
  InteractiveMessage toInteractiveMessage() {
    ...
    if (Utils.isValidString(goalCompletionText)) {
      interactiveData[ModelFieldConstants.goalCompletionText] = goalCompletionText;
    }
  ...
  factory FormMessage.fromInteractiveMessage(InteractiveMessage message) {
    ...
    //   submitElement = ButtonElement.fromMap(message.interactiveData[ModelFieldConstants.submitElement]);
    // } else {
    //   submitElement =
    //       ButtonElement(elementType: UIElementTypeConstants.button, elementId: "xxx1234xxx", buttonText: "Not found");
    // }
    ...
    return FormMessage(
      ...
      goalCompletionText: message.interactiveData[ModelFieldConstants.goalCompletionText],
  ...
  Map<String, dynamic> toJson() {
    ...
    // map[ModelFieldConstants.formFields] = formFields.map((e) => e.toMap()).toList();
