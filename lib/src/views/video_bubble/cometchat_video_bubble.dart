              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => VideoPlayer(
                            backIcon: theme.palette.getPrimary(),
                            fullScreenBackground: theme.palette.getBackground(),
                            videoUrl: videoUrl,
                          )));
            }
          },
              ...
              child: thumbnailUrl != null && thumbnailUrl!.isNotEmpty
                  ? FadeInImage(
                      placeholder: AssetImage(
                          ...
                          package: placeHolderImagePackageName ??
                      ...
                      image: NetworkImageWithRetry(thumbnailUrl!, fetchStrategy:
            ...
            Align(
              ...
              child: playIcon ??
                  Icon(
                    ...
                    size: 56.0,
                    color: style?.playIconTint ?? theme.palette.getPrimary(),
                  ),
            )
          ],
        ),
