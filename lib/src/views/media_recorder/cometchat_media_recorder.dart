...
import 'package:kaliro_cometchat_uikit_shared/src/views/media_recorder/_audio_visualizer.dart';
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                color: !_isRecording && _isAudioRecordingCompleted
                    ? _theme.palette.getAccent50()
                    : Colors.transparent,
                borderRadius: _isAudioRecordingCompleted
                    ? BorderRadius.circular(
                        widget.mediaRecorderStyle?.borderRadius ?? 16.18)
                    : BorderRadius.only(
                        topLeft: Radius.circular(
                            widget.mediaRecorderStyle?.borderRadius ?? 8),
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
              Flexible(
                flex: 1,
                child: !_isRecording && _isAudioRecordingCompleted
                    ? getMediaButtons()
                    : _isRecording
                        ? Text(
                            ...
                            style: TextStyle(
                                    ...
                                    fontSize:
                                        _theme.typography.caption2.fontSize,
                                    fontWeight:
                                        _theme.typography.text2.fontWeight)
                                .merge(
                                    widget.mediaRecorderStyle?.timerTextStyle),
              ...
              if (_isAudioRecordingCompleted)
                Text(
                  ...
                  style: TextStyle(
                      ...
                      .merge(widget.mediaRecorderStyle?.timerTextStyle),
                  textAlign: TextAlign.center,
                )
            ]),
          ),
  ...
  void startRecording() async {
    ...
    if (result) {
      ...
      setState(() {
        ...
        _isRecording = true;
        _isPlaying = false;
        audioBar = AudioVisualizer(
          color: widget.mediaRecorderStyle?.audioBarTint ??
              _theme.palette.getAccent700(),
